    ...
    <Page>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={8}>
          <Paper>
            <Box p={4}>
              <h2>Welcome to Kybalion Financial</h2>
              <p>The first algorithmic stablecoin on Fantom Opera, pegged to the price of 1 FTM via seigniorage.</p>
              <p>
                Stake your KYB-ELA LP in the Cemetery to earn HERM rewards.
                Then stake your earned HERM in the Masonry to earn more KYB!
              </p>
            </Box>
          </Paper>
